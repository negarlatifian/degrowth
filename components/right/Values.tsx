      ...
      <div className='flex flex-row justify-between'>
        <div className='flex flex-col' ref={ref}>
          ...
          <TextEndnote>
            ...
            material comfort but also social relationships, autonomy, ecological
            sustainability, and a sense of purpose. It involves a balanced and
            equitable distribution of resources, fostering resilient
            communities, and a lifestyle that respects the ecological limits of
          ...
          <TextEndnote>
            ...
            sustenance, reproduction and the contentment of human relations.
            This already touches all facets of human life, but to focus within
            the art world, this includes all of the unseen work that goes into
            making sure everything runs smoothly: that the space is cleaned,
            coffee and wine are available, admin is taken care of, fellow
            collaborators don’t kill each other.
          </TextEndnote>
          <TextEndnote>
          ...
          <TextEndnote>
            ...
            commitment to a shared goal. It’s important here to not fall into
            the trap of an idealised depiction of community as a place of
            unconditional love and support (such a thing does not exist), or as
            a vague catch-all term denoting a group of people who presumably
            have the same experiences or interests (that is, of course,
            presumptuous). Communities are fundamentally pragmatic networks of
            autonomous members based upon reciprocal relationships that must
            function, and require continued care work in order to maintain their
            health and functionality.
          </TextEndnote>
          <TextEndnote>
            The emphasis on community and collectivity here works in tandem with
            the point made in the section on care: pushing back against the idea
            of the individual as an isolated being.{' '}
          </TextEndnote>
          <TextEndnote>
            On a practical level, coming together and pooling resources creates
            a synergy effect – leading to a more intensive and diverse use of
            resources, and therefore to a strengthening of a solidarity-based
            culture of contributions. This, in turn, can promote mutual
            inspiration and local support. And, of course, in terms of bringing
            about change in the art world: the reality is that no systemic
            change can be achieved by lone individuals, and when we work alone
            we are much easier to push around.
          </TextEndnote>
        </div>
