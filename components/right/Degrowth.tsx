      ...
      <div className='flex flex-row justify-between'>
        <div className='flex flex-col'>
          <TextEndnote>
            ...
            across the board with improvement, prosperity, well-being: the more
            we – as individuals, institutions, nations – produce and accumulate,
            the better we’re doing. And, consequently, our objectives tend to be
            growth-oriented. As our governments are always striving for higher
            GDP ratings, we also strive to work more, produce more, earn more.
            Those of us in the arts, too, tend to assume that the more we work
            and the more art we push out, the more opportunities will come our
            way, the more capital (financial or cultural) we will gain. At its
            very foundation, the continued existence of the capitalist system
            relies on perpetual economic development. Degrowth, conversely,
            points out the simple fact that infinite growth on a finite planet
            is impossible.
          </TextEndnote>
          ...
          <TextEndnote>
            ...
            the values of well-being of human and non-human life, equitability,
